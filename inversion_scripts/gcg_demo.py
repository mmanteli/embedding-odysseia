...
model_path = "/scratch/project_462000883/amanda/llamackpts/llama2-7b-chat-hf"
...
model, tokenizer = load_model_and_tokenizer(model_path, 
                       ...
                       use_cache=False,
                       device=device)
print(f'Model and tokenizer loaded', flush=True)
...
for i in range(num_steps):
    ...
    print(f'Control slice is: {suffix_manager.tokenizer.decode(input_ids[suffix_manager._control_slice])} ({suffix_manager._control_slice})')
